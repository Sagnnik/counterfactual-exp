...
'''
file_path = 'annotations/icqa_dataset/IID/json/example_24.json'
...
for i in range(125):  # number of frames
    ...
    #cv2.imwrite(f'/content/CRIPP-VQA/saved_img/img_{n}.png', images)
    #n=n+1
    TDWUtils.save_images(images, filename="{:04d}".format(i), output_directory="saved_imgs")
